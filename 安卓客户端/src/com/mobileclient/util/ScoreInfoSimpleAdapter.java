...
/*需要绑定的数据*/
    ...
    public ScoreInfoSimpleAdapter(Context context, List<? extends Map<String, ?>> data, int resource, String[] from, int[] to,ListView listView) { 
  ...
  public View getView(int position, View convertView, ViewGroup parent) { 
	  ...
	  if (convertView == null) convertView = mInflater.inflate(R.layout.scoreinfo_list_item, null);
