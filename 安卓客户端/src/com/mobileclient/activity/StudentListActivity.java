				...
				handler.post(new Runnable() {
					...
					public void run() {
						...
						adapter = new StudentSimpleAdapter(StudentListActivity.this, list,
	        					...
	        					new int[] { R.id.tv_studentNumber,R.id.tv_studentName,R.id.tv_studentSex,R.id.tv_studentClassNumber,R.id.iv_studentPhoto,},lv);
	...
	private List<Map<String, Object>> getDatas() {
		...
		try {
			...
			for (int i = 0; i < studentList.size(); i++) {
				...
				map.put("studentSex", studentList.get(i).getStudentSex());
				map.put("studentClassNumber", studentList.get(i).getStudentClassNumber());
