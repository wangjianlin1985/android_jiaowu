...
public class MoreActivity extends Activity {
	private String[] strs = new String[]{"学生信息","教师信息","课程信息","选课信息","成绩信息","新闻信息","修改个人信息","关于"};
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		list.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
				...
				if(arg2 == 2){
					Intent intent  = new Intent(MoreActivity.this, CourseInfoListActivity.class);
					startActivity(intent);
				}
				if(arg2 == 3){
					Intent intent  = new Intent(MoreActivity.this, StudentSelectCourseInfoListActivity.class);
					startActivity(intent);
				}
				if(arg2 == 4){
					Intent intent  = new Intent(MoreActivity.this, ScoreInfoListActivity.class);
					startActivity(intent);
				}
				if(arg2 == 5){
