...
import com.mobileclient.util.ActivityUtils;import com.mobileclient.util.SpecialFieldInfoSimpleAdapter;
...
public class SpecialFieldInfoListActivity extends Activity {
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if(requestCode == ActivityUtils.ADD_CODE && resultCode == RESULT_OK) {
        	queryConditionSpecialFieldInfo = null;
        	setViews();
        }
    }
		...
		new Thread(){
			...
			public void run() {
				...
				handler.post(new Runnable() {
					...
					public void run() {
						dialog.cancel();
						adapter = new SpecialFieldInfoSimpleAdapter(SpecialFieldInfoListActivity.this, list,
	        					R.layout.specialfieldinfo_list_item,
	        					new String[] { "specialFieldNumber","specialFieldName","specialCollegeNumber" },
	        					new int[] { R.id.tv_specialFieldNumber,R.id.tv_specialFieldName,R.id.tv_specialCollegeNumber,},lv);
