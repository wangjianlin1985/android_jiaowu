...
public class StudentSelectCourseInfoEditActivity extends Activity {
	...
	private void initViewData() {
		...
		for (int i = 0; i < studentList.size(); i++) {
			if (studentSelectCourseInfo.getStudentNumber().equals(studentList.get(i).getStudentNumber())) {
				this.spinner_studentNumber.setSelection(i);
				break;
			}
		}
		for (int i = 0; i < courseInfoList.size(); i++) {
			if (studentSelectCourseInfo.getCourseNumber().equals(courseInfoList.get(i).getCourseNumber())) {
