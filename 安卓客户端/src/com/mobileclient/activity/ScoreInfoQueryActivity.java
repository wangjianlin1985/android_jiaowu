	...
	public void onCreate(Bundle savedInstanceState) {
		...
		spinner_studentNumber.setOnItemSelectedListener(new OnItemSelectedListener() {
			...
			public void onItemSelected(AdapterView<?> arg0, View arg1,int arg2, long arg3) {
				if(arg2 != 0)
					queryConditionScoreInfo.setStudentNumber(studentList.get(arg2-1).getStudentNumber()); 
				else
		...
		spinner_courseNumber.setOnItemSelectedListener(new OnItemSelectedListener() {
			...
			public void onItemSelected(AdapterView<?> arg0, View arg1,int arg2, long arg3) {
				if(arg2 != 0)
					queryConditionScoreInfo.setCourseNumber(courseInfoList.get(arg2-1).getCourseNumber()); 
				else
