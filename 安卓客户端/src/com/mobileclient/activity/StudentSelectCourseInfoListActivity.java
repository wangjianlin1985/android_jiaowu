...
import com.mobileclient.util.ActivityUtils;import com.mobileclient.util.StudentSelectCourseInfoSimpleAdapter;
...
public class StudentSelectCourseInfoListActivity extends Activity {
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if(requestCode == ActivityUtils.ADD_CODE && resultCode == RESULT_OK) {
        	queryConditionStudentSelectCourseInfo = null;
        	setViews();
        }
    }
		...
		new Thread(){
			...
			public void run() {
				...
				handler.post(new Runnable() {
					...
					public void run() {
						dialog.cancel();
						adapter = new StudentSelectCourseInfoSimpleAdapter(StudentSelectCourseInfoListActivity.this, list,
	        					R.layout.studentselectcourseinfo_list_item,
	        					new String[] { "studentNumber","courseNumber" },
	        					new int[] { R.id.tv_studentNumber,R.id.tv_courseNumber,},lv);
