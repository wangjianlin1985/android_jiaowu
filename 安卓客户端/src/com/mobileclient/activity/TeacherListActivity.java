				...
				handler.post(new Runnable() {
					...
					public void run() {
						...
						adapter = new TeacherSimpleAdapter(TeacherListActivity.this, list,
	        					...
	        					new int[] { R.id.tv_teacherNumber,R.id.tv_teacherName,R.id.tv_teacherSex,R.id.tv_teacherBirthday,R.id.iv_teacherPhoto,},lv);
	...
	private List<Map<String, Object>> getDatas() {
		...
		try {
			...
			for (int i = 0; i < teacherList.size(); i++) {
				...
				map.put("teacherName", teacherList.get(i).getTeacherName());
				map.put("teacherSex", teacherList.get(i).getTeacherSex());
				map.put("teacherBirthday", teacherList.get(i).getTeacherBirthday());
