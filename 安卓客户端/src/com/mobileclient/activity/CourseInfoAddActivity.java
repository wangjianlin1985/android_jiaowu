			...
			public void onClick(View v) {
				try {
					...
					if(ET_courseNumber.getText().toString().equals("")) {
						Toast.makeText(CourseInfoAddActivity.this, "课程编号输入不能为空!", Toast.LENGTH_LONG).show();
						ET_courseNumber.setFocusable(true);
						ET_courseNumber.requestFocus();
						return;
					}
					courseInfo.setCourseNumber(ET_courseNumber.getText().toString());
					/*验证获取课程名称*/ 
					if(ET_courseName.getText().toString().equals("")) {
						Toast.makeText(CourseInfoAddActivity.this, "课程名称输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_courseTime.getText().toString().equals("")) {
						Toast.makeText(CourseInfoAddActivity.this, "上课时间输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_coursePlace.getText().toString().equals("")) {
						Toast.makeText(CourseInfoAddActivity.this, "上课地点输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_courseScore.getText().toString().equals("")) {
						Toast.makeText(CourseInfoAddActivity.this, "课程学分输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_courseMemo.getText().toString().equals("")) {
						Toast.makeText(CourseInfoAddActivity.this, "附加信息输入不能为空!", Toast.LENGTH_LONG).show();
