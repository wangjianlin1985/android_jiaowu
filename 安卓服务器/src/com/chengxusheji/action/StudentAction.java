...
public class StudentAction extends BaseAction {
    ...
    public String QueryStudentOutputToExcel() { 
        ...
        if(studentName == null) studentName = "";
        if(studentBirthday == null) studentBirthday = "";
        List<Student> studentList = studentDAO.QueryStudentInfo(studentNumber,studentName,studentClassNumber,studentBirthday);
        ...
        for(int i=0;i<studentList.size();i++) {
        	...
        	dataset.add(new String[]{student.getStudentNumber(),student.getStudentName(),student.getStudentSex(),student.getStudentClassNumber().getClassName(),
new SimpleDateFormat("yyyy-MM-dd").format(student.getStudentBirthday()),student.getStudentState(),student.getStudentPhoto(),student.getStudentTelephone(),student.getStudentEmail(),student.getStudentQQ()});
        }
        /*
